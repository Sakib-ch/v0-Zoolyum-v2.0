                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-slate-600 mb-3">
                          Great article! I&apos;ve been implementing some of these strategies for my business and have seen
                          significant growth in our online presence.
                        </p>
                        <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-slate-600 mb-3">
                          I&apos;d love to see more specific examples of how small businesses can implement these strategies
                          with limited resources. Any thoughts on that?
                        </p>
                        <div className="flex items-center space-x-4">
                          <button className="text-xs text-slate-500 hover:text-orange-500 flex items-center">
                            <Heart className="w-3 h-3 mr-1" />
                        ...
                        <div className="mt-4 ml-6 pt-4 border-t border-slate-100">
                          <div className="flex items-start">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-slate-600 mb-3">
                                Great question, Jennifer! I&apos;m actually working on a follow-up article specifically for
                                small businesses with limited resources. Stay tuned!
                              </p>
                              <div className="flex items-center space-x-4">
                                <button className="text-xs text-slate-500 hover:text-orange-500 flex items-center">
                                  <Heart className="w-3 h-3 mr-1" />
